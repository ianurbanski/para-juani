class boton {
  ...
  click() {
    if (this.posicionMouse()) {
      pantallaActual = this.siguientePantalla; // Cambia a la siguiente pantalla
    }
  }
}
...
function mousePressed() {  
  ...
  if (pantallaActual === "perder") {
    if (objJuego.botonReiniciar.posicionMouse()) {
      pantallaActual = "inicio"; // Reinicia el juego y vuelve a la pantalla de inicio
      objJuego = new juego(); // Reinicia el objeto del juego
    }
  }
